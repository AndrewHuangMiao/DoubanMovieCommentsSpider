      ...
      <div id="content">
        ...
        <div class="col-md-8">
          <div clas="row">
            <div class="col-md-12">
              <h2>{{movieName}}的影评</h2>
              <div>全部:<span id="totalComment"></span>条<button type="button" class="btn btn-small btn-primary" ng-click="download()" style="margin-left: 620px;">下载评论</button></div>
          ...
          if(isExist==true){
            ...
            $.ajax({
              ...
              success: function (doubanComments) {
                if(doubanComments==undefined||doubanComments==null){
                  return;
                }
          ...
          if (isExist == true) {
            ...
            $.ajax({
              ...
              success: function (movieDetail) {
                ...
                debugger;
                $('#totalComment').text(movieDetail.totalComment);
